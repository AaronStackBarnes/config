tell application "iTerm2"
    ...
    tell _new_session
        write text "cd ~/websites/stamps/stampsApp/ && mdcat ~/websites/stamps/stampsApp/README.md && wamin"  
    end tell
    tell current window
        create tab with default profile
    end tell
    ...
    tell _new_session
        write text "ssh -t root@167.99.235.109 'cd stampsServer/; pm2 logs; exec $SHELL'"  
    end tell
    tell current window
        create tab with default profile
    end tell
